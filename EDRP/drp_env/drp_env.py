	...
	def step(self, joint_action):
		...
		if self.is_tasklist:
			...
			if self.step_account % 10 == 0:
				...
				#self.current_tasklist, self.assigned_tasks = TaskManager.assign_task_v2(self.agent_num, self.current_tasklist, self.assigned_tasks, self.G, self.obs, self.pos, self.start_ori_array)
				self.current_tasklist, self.assigned_tasks = TaskManager.assign_task(self.agent_num, self.current_tasklist, self.assigned_tasks) #Assignement without A star
